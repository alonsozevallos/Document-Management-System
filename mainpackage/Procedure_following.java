...
public class Procedure_following extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Procedure_following.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
